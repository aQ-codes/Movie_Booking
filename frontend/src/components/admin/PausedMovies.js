...
function PausedMovies() {
 ...
 //   if (user){
     ...
     axios.get('http://127.0.0.1:8000/api/movies/paused'
 // //     {
...
return (
 ...
 <div className="row">
   ...
   <div class="card">
   <div class="card-header card-header-e movies-status-header bg-secondary text-dark">PAUSED MOVIES</div>
